...
class BothDatatable extends DataTable
{
    /**
     ...
     */
    public function dataTable($query)//to show the details of the user who is both seller and a buyer
    {
    ...
    {
        return $model->newQuery()->select('id', DB::raw('CONCAT(FirstName," ", Surname ) AS name'), 'email', 'phone_no', 'bank_no', 'created_at', 'updated_at')->where('Cstatus','=','Both')->where('Astatus','=','verified');

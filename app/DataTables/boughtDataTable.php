...
class boughtDataTable extends DataTable
{
    /**
...
//                dd($wow);
    ...
    {
        $id=Auth::user()->id;
        return $model->newQuery()->select('id','lotReferenceNumber', 'sold','estimated_price_from', 'estimated_price_to', 'reservePrice')->where('sold_to_id','=',$id);
    }

...
class InReviewDataTable extends DataTable
{
    /**
...
//                dd($wow);
    ...
    {
        return $model->newQuery()->select('id','lotReferenceNumber', 'sold','estimated_price_from', 'estimated_price_to', 'reservePrice')->where('approved','=',null);
    }

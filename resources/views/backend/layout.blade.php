...
<nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
    ...
    <h4 style="color:whitesmoke">Admin {{Auth::user()->FirstName}} {{Auth::user()->Surname}}</h4>
...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4 d-flex justify-content-center row">

        ...
        <div class="row justify-content-center">
            <div class="col-md-9">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        @php
                            $imageName=$item->image()->first();
                            if(!($imageName=$item->image()->first()==null)){
                                                        $imageName=$imageName->image;
                            }
                        else
                        $imageName='';
                        @endphp
                        <img class="card-img-top" src="{{asset("images/item/".$imageName)}}" alt="No Image Found">                              <br>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {{ Form::number('max',null, array('class' => 'form-control col-md-7 col-xs-12','required'=>'')) }}
                            </div>
                            </div>
                        </div>

...
@section('content')
    ...
    <div class="container marketing ">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <img class="bd-placeholder-img" width="340" height="340" src="{{asset('images/slider/1.jpg')}}" focusable="false" role="img" aria-label="Placeholder: 140x140"><title>Placeholder</title></img>
                <h2>Heading</h2>
        ...
        <div class="row featurette">
            ...
            <div class="col-md-5">
                <img class="bd-placeholder-img" width="500" height="500" src="{{asset('images/slider/1.jpg')}}" focusable="false" role="img" aria-label="Placeholder: 140x140"><title>Placeholder</title></img>
